  ...
  return (
    <>
      <div className='bg-black px-4 flex flex-col gap-4 lg:px-10 py-4'> {/* Parent Div */}
        ...
        <div className='flex gap-10 px-2 lg:px-4 justify-center'> {/* Row Container */}
          {/* First Item */}
          <div 
          ...
          >
            ...
            <div className="flex h-full justify-end items-end pl-4 pb-4 relative z-10">
              ...
              {/* Text Content */}
              <div className="pl-4">
                <h1 className='text-start text-gray-400 text-base font-semibold mb-2'>Community Engagement</h1>
                <p className='text-start text-gray-400 w-[16rem] text-sm'>
          ...
          >
            ...
            <div className="flex justify-end items-end h-full pl-4 pb-4 relative z-10">
              ...
              {/* Text Content */}
              <div className="pl-4">
                <h1 className='text-start text-gray-400 text-base font-semibold mb-2'>Partnerships & Integrations</h1>
                <p className='text-start text-gray-400 w-[16rem] text-sm'>
        ...
        <div className='flex gap-10 px-2 lg:px-4 justify-center'> {/* Row Container */}
          ...
          >
            ...
            <div className="flex h-full justify-end items-end pl-4 pb-4 relative z-10">
              ...
              {/* Text Content */}
              <div className="pl-4">
                <h1 className='text-start text-gray-400 text-base font-semibold mb-2'>Educational Content</h1>
                <p className='text-start text-gray-400 w-[16rem] text-sm'>
          ...
          >
            ...
            <div className="flex justify-end items-end h-full pl-4 pb-4 relative z-10">
              ...
              {/* Text Content */}
              <div className="pl-4">
                <h1 className='text-start text-gray-400 text-lg font-semibold mb-2'>Referral Program</h1>
                <p className='text-start text-gray-400 w-[16rem] text-sm'>
