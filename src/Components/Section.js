...
const Section = () => {
  return (
    <>
    <div className='px-4 lg:px-10 py-4 flex flex-col gap-4 justify-center items-center' style={{
    ...
    <h1 className='font-bold text-2xl text-gray-600 text-center pb-2'>Technology Stack</h1>
        ...
        <div className='hidden w-[55rem] lg:flex justify-between'> {/*Child Div */}
            ...
            <div className='flex flex-col gap-4 w-1/2'> {/*Content Div */}
                ...
                <h1 className='text-2xl font-bold text-start text-gray-600'>AI & Machine Learning</h1>
                ...
                <h1 className='text-2xl font-bold text-start text-gray-600'>Blockchain & Smart Contracts</h1>
              ...
              <h1 className='text-2xl font-bold text-start text-gray-600'>Data Analytics Tools</h1>
              ...
              <h1 className='text-2xl font-bold text-start text-gray-600'>Frontend & User Interface</h1>
            ...
            <div className='flex items-center justify-center'> {/*Image Div */}
                <img className='w-[22rem]' src='/ContractIQ-Ai-01.jpg' />
            </div> {/*Image Div */}
