...
const BrandingAndDesign = () => {
  return (
    ...
    <div className='bg-black flex flex-col px-4 lg:px-10 py-4'> {/*Parent Div */}
        ...
        <div className='flex gap-4 justify-center'> {/*Child Div */}
            <div className='flex flex-col px-2 py-2 bg-red-600 items-center w-1/4'>
            <img className='w-20' src='/pen-tool.png' />
            ...
            <div className='flex flex-col bg-red-600 px-4 py-4 items-center w-1/4'>
            <img className='w-20' src='/palette.png' />
            ...
            <div className='flex flex-col bg-red-600 py-4 px-4 items-center w-1/4'>
            <img className='w-20' src='/microphone.png' />
